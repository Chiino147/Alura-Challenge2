...
var partida = {
    ...
    intentos: 0,
    gano: false,
    palabras: ["CAMA", "MAESTRA", "MEDICO", "APRENDIZAJE", "MUSEO", "COPA", "CASA", "VERDE", "PEZ", "OSO", "ARGENTINA", "GATO", "CHOCOLATE", "AGUA", "BANANA", "MOTO", "PERRO", "MANZANA", "SOL", "PELOTA", "NARANJA", "AVION", "DINERO", "ROJO", "CORAZON"],
    palabra: "",
    arrayletras: [],
    rejugar: false,
    letraIncorrectas: [],
